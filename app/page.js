  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center px-6">
      ...
      <div className="mt-10 grid gap-4 w-full max-w-md">
        <button className="bg-blue-600 hover:bg-blue-700 rounded-xl p-4 font-semibold">
          Painel da Transportadora
        </button>

        <button className="bg-green-600 hover:bg-green-700 rounded-xl p-4 font-semibold">
          Área do Motorista
        </button>

        <button className="bg-orange-500 hover:bg-orange-600 rounded-xl p-4 font-semibold">
          Acompanhar Carga
        </button>
      </div>
    </main>
